...
module Wren::Core
  class WebsiteFile < WebsiteBase
    include Wren::Filters
    include Wren::Renderers
    include Wren::PreProcessors
    include Wren::PostProcessors
    include Wren::Translators
    ...
    def get_raw_contents
      load_file_info! if @raw_contents.nil?
      @raw_contents
    end
    ...
    def layout
      @layout ||= Wren::Core::Layout.new(template)
    end
